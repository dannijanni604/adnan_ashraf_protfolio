...
class CertificateGrid extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GridView.builder(
        padding: EdgeInsets.symmetric(horizontal: Responsive.isMobile(context) ? 0 : 30),
        ...
        itemBuilder: (context, index) {
          return Obx(() => AnimatedContainer(
              ...
              decoration: BoxDecoration(borderRadius: BorderRadius.circular(Responsive.isMobile(context) ?20:30), gradient: const LinearGradient(colors: [Colors.pinkAccent, Colors.blue]), boxShadow: [
