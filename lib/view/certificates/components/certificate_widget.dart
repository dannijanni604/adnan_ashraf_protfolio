...
class CertificateWidget extends StatelessWidget {
  ...
  CertificateWidget({super.key, required this.index});
            ...
            child: SingleChildScrollView(
              ...
              Text.rich(
                  ...
                  TextSpan(
                      ...
                      children: [TextSpan(text: certificateList[index].skills, style: const TextStyle(color: Colors.grey, overflow: TextOverflow.ellipsis))])),
              const SizedBox(height: defaultPadding),
              InkWell(
                  ...
                  child: Container(
                      ...
                      child: const Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                        Text('Certificate or License', style: TextStyle(color: Colors.white, fontSize: 10)),
                        SizedBox(width: 5),
