          ...
          builder: (context, value, child) {
            return InkWell(
                ...
                child: Container(
                    ...
                    child: Center(
                        child: ShaderMask(
                            shaderCallback: (bounds) => LinearGradient(colors: [Colors.pink, Colors.blue.shade900]).createShader(bounds),
                            child: Icon(Icons.menu, color: Colors.white, size: defaultPadding * 1.2 * value)))));
          }),
      const Spacer(flex: 5)
    ]);
  }
